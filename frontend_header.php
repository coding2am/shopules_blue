...
<div class="container-fluid">
    ...
    <div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
        ...
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
            ...
            <a href="index.php"><img src="logo/logo_big.png" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none"></a>

            <a href="index.php"><img src="logo/logo_med.png" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px"></a>

            <a href="index.php"><img src="logo/logo.png" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px"></a>
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
            <div class="row">
                ...
                <div class="col-lg-4 col-10">
                    ...
                    ?>
                        <!--if user exist-->
                        <a class="text-info" href="javascript:void(0)" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right" data-toggle="dropdown" role="button">
                            <?= $_SESSION['login_user']['name']; ?>
                            <i class="icofont-rounded-down"></i>
                        </a>
                        <div class="dropdown-menu text-info" aria-labelledby="dropdownMenuButton">
                    ...
                    <?php } else { ?>
                        <a href="login.php" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none text-info loginLink float-right"> Login | Sign-up </a>
                    <?php } ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
            ...
            <img src="frontend/image/download_logo.png" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px">
        </div>
    </div>
</div>
<div id="myPage"></div>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            ?>
                            <li><a class="dropdown-item" href="sub_category.php?sc_id=<?= $sid?>&c_id=<?= $id; ?>"><?= $sname ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <div class="dropdown-divider"></div>
            ...
            <div class="hov-dropdown d-inline-block">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                    ...
                    foreach ($brands as $brand)
                    {
                        ...
                        $name = $brand["name"];
                    ?>
                    <a class="dropdown-item" href="brand.php?bid=<?= $id; ?>"><?= $name ?></a>
                    <div class="dropdown-divider"></div>
                    <?php }?>
                </div>
            </div>
...
<div id="mySidebar" class="sidebar">
    ...
    <div class="mt-3">
        ...
        <div class="collapse sidebardropdown_container_category mt-3" id="category_<?= $id ?>">
            ...
            $sname = $subcategory["name"];
            ?>
            <a href="sub_category.php?sc_id=<?= $sid?>&c_id=<?= $id; ?>"" class="py-2"> <?= $sname ?> </a>
            <?php } ?>
        </div>
        ...
        <div class="collapse sidebardropdown_container_category mt-3" id="brand">
            ...
            foreach ($brands as $brand)
            {
                ...
                $name = $brand["name"];
                ?>
                <a href="brand.php?bid=<?= $id; ?>" class="py-2"> <?= $name ?></a>
            <?php }?>
        </div>
        <hr>
        ...
        ?>
        <a class="text-info" data-toggle="collapse" href="#user" role="button" aria-expanded="false" aria-controls="user">
            <?= $_SESSION['login_user']['name']; ?>
            <i class="icofont-rounded-down"></i>
        </a>
        ...
        <img src="frontend/image/download_logo.png" class="img-fluid ml-2 text-center" style="width: 150px">
        <hr>
