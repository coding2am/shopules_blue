...
<footer class="py-3 mt-5">
    <div class="container">
        ...
        <p style="opacity: 0.8" class="m-0 text-center text-light">Copyright &copy; <img class="mr-2" src="logo/logo_wh_transparent.png" style="width: 30px; height: 30px"> 2020 MIC Bootcamp batch-18</p>
        <div class="text-light text-center">
            <div style="opacity: 0.6">from</div>
            <div style="opacity: 0.8">2amCoders</div>
        </div>
    </div>
</footer>
